...
if getgenv().Nousigi then 
	if game.CoreGui:FindFirstChild("Tiro Hub GUI") then
		for i, v in ipairs(game.CoreGui:GetChildren()) do
			if string.find(v.Name,  "Tiro Hub") then
				v:Destroy()
			end
		end
	end
...
local T1UIColor = {
    ...
    ["Logo Image"] = "rbxassetid://79932823311771",
...
Library_Function.Gui.Name = 'Tiro Hub GUI'
...
ImageLabel.Image = "rbxassetid://79932823311771"
...
local libCreateNoti = function(Setting)
    ...
    TextLabelNoti.Text = "<font color=\"rgb(" .. tostring(color or "255,80,80") .. ")\">" .. tostring(TitleNameMain or "Tiro Hub") .. "</font> " .. tostring(getgenv().TitleNameNoti or "")
...
function Library:CreateWindow(Setting)
    local TitleNameMain = Setting.Title or "Tiro Hub"
   ...
   TextLabelMain.Text = "<font color=\"rgb(0,0,0)\">" .. tostring(TitleNameMain or "Tiro Hub") .. "</font> <font color=\"rgb(255,255,255)\">" .. tostring(getgenv().MainDesc or "") .. "</font>"
